...
<html>
<head>
<title>Enotour&reg; / Solicitud de Reserva</title>
...
<form action="solicitud_de_reserva.mail.php" method="post" enctype="application/x-www-form-urlencoded" name="form11" id="form11">
        ...
        <table width="740" border="0" align="center" cellpadding="5" cellspacing="5" bordercolor="#000000">
          <tr>
            <td width="32%" valign="top"><div align="right"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Nombre</font></div></td>
            <td width="68%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
              <input name="first_name" type="text" id="first_name" size="50">
            </font></td>
          </tr>
          <tr>
            <td valign="top"><div align="right"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Apellido</font></div></td>
          ...
          <tr>
            ...
            <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
              <input name="nationality" type="text" id="empresa" size="50">
            </font></td>
          </tr>

          <tr>
            <td valign="top"><div align="right"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Tel&eacute;fono</font></div></td>
            <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                ...
                <tr >
                  <td colspan="3"><table width="100%" border="0" cellspacing="5" cellpadding="5">
                    <tr>
                      <th colspan="3" valign="top"><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#333333">Tipo de habitaci&oacute;n </font></strong></font></div></th>
                    ...
                    <tr valign="middle">
                      <td><div align="right">
                        <blockquote>
                          <p><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Fecha de llegada </font></p>
                        </blockquote>
                      </div></td>
                      <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                      ...
                      <td><div align="right"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">N&deg; Noches </font></div></td>
                      <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
...
No</label>
                      ...
                      <tr>
                        ...
                        <td><font face="Verdana, Arial, Helvetica, sans-serif">
                          <select name="payment" id="payment">
                            ...
                            <option value="deposit_current_account">Dep&oacute;sito cuenta corriente</option>
                            <option value="check">Cheque</option>
                          </select>
                          <br>
                          <font color="#333333" size="1">*Este antecedente es s&oacute;lo para tener una referencia. </font></font></td>
                      </tr>
                    </table></td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="5" cellpadding="5">
                ...
                <tr valign="middle">
                  ...
                  <td>                    <div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Hotel Casa Real de Vi&ntilde;a Santa Rita</font></div></td>
                </tr>
                <tr valign="middle">
                  <td><div align="center">
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <td>                    <div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Casa Tarapac&aacute;</font></div></td>
                </tr>
                <tr valign="middle">
                  <td><div align="center">
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <td>                    <div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Casa de Hu&eacute;spedes de Vi&ntilde;a Mar</font></div></td>
                </tr>
                <tr valign="middle">
                  <td><div align="center">
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <td>                    <div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">San Crist&oacute;bal Tower</font></div></td>
                  <td><div align="center">
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <tr valign="middle">
                  ...
                  <td>                    <div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Casa de Hu&eacute;spedes de Casa Donoso</font></div></td>
                </tr>
                <tr valign="middle">
                  <td><div align="center">
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <td><div align="left"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Hotel Tabonk&ouml; de Vi&ntilde;a  G&iuml;llmore</font></div></td>
                </tr>
                <tr valign="middle">
                  <td colspan="2" valign="top"><div align="center"><font color="#333333" size="1" face="Verdana, Arial, Helvetica, sans-serif">Comentarios</font></div></td>
