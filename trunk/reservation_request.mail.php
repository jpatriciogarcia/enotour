        ...
        <table width=\"740\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"5\" bordercolor=\"#000000\">
          <tr>
            ...
            <td width=\"68%\"><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
              <input name=\"first_name\" type=\"text\" id=\"first_name\" size=\"50\" value=\"".$_POST['first_name']."\">
            </font></td>
          </tr>
          <tr>
            ...
            <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
              <input name=\"last_name\" type=\"text\" id=\"last_name\" size=\"50\" value=\"".$_POST['last_name']."\">
            </font></td>
          </tr>
          <tr>
            <td valign=\"top\"><div align=\"right\"><font color=\"#333333\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">Nationality</font></div></td>
            <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
              <input name=\"nationality\" type=\"text\" id=\"empresa\" size=\"50\"  value=\"".$_POST['nationality']."\">
            </font></td>
          </tr>
          ...
          <tr>
            <td valign=\"top\"><div align=\"right\"><font color=\"#333333\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">Phone
                Number</font></div></td>
            <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
              <input name=\"phone_number\" type=\"text\" id=\"telefono24\" size=\"50\"  value=\"".$_POST['phone_number']."\">
            </font></td>
          </tr>
          <tr>
            ...
            <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
              <input name=\"email\" type=\"text\" id=\"telefono23\" size=\"50\"  value=\"".$_POST['email']."\">
            </font></td>
          </tr>
          <tr>
                ...
                <tr >
                  <td colspan=\"3\"><table width=\"100%\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\">
                    ...
                    <tr valign=\"middle\">
                      ...
                      <td width=\"28%\"><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                      ...
                      <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                        <input name=\"nights\" type=\"text\" id=\"nights\">
                      </font></td>
                    </tr>
                    ...
                    <div align=\"center\">
                      <table width=\"100%\">
                        <tr>
                          ...
                          <label>
                          <input type=\"radio\" name=\"air_travel\" value=\"yes\" onChange=\"document.getElementById('divairtravel').style.display='block'\">
Yes</label>
                          <label>
                          <input name=\"air_travel\" type=\"radio\" onChange=\"document.getElementById('divairtravel').style.display='none'\" value=\"no\" checked>
No</label>
                          </font> </th>
                        </tr>
                      </table>
                    ...
                    <table width=\"100%\" border=\"0\" cellpadding=\"5\" cellspacing=\"5\" bgcolor=\"#FFFFFF\">
                      ...
                      <tr valign=\"middle\">
                        ...
                        <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                          <input name=\"air_travel_arrival\" type=\"text\" id=\"air_travel_arrival\">
                        </font></td>
                        <td><div align=\"center\"><font color=\"#333333\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">Departure Date </font></div></td>
                        <td><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                          <input name=\"air_travel_departure\" type=\"text\" id=\"air_travel_departure\">
                        </font></td>
                      </tr>
                      <tr valign=\"middle\">
      ...
      <p align=\"center\"><font color=\"#333333\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">
        <a href=\"#\">Knows about our terms and conditions</a><br>
        <br>
        </font></p>      </td>
  </tr>
</table>
